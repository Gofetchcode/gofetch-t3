...
const vehicles = [
  { name: "2025 Porsche 911 Carrera", msrp: "$115,400", note: "Porsche loyalty incentives and allocation advantages available", img: "https://images.unsplash.com/photo-1748606331782-41ecb53bd016?w=800&h=500&fit=crop&crop=center&q=80" },
  { name: "2025 BMW M4 Competition", msrp: "$82,900", note: "BMW currently offering competitive conquest rates", img: "https://images.unsplash.com/photo-1744782558819-061b352200fa?w=800&h=500&fit=crop&crop=center&q=80" },
  { name: "2025 Mercedes-AMG C63 S", msrp: "$87,500", note: "Hybrid AMG powertrain — dealer inventory available", img: "https://images.unsplash.com/photo-1751467928449-aa58e7662a39?w=800&h=500&fit=crop&crop=center&q=80" },
  { name: "2025 Audi RS e-tron GT", msrp: "$109,800", note: "EV incentives creating significant savings opportunities", img: "https://images.unsplash.com/photo-1528597469186-bddab681a37f?w=800&h=500&fit=crop&crop=center&q=80" },
  { name: "2025 Maserati Grecale GT", msrp: "$63,500", note: "Strong dealer incentives on current inventory", img: "https://images.unsplash.com/photo-1573939843793-2da032b19f94?w=800&h=500&fit=crop&crop=center&q=80" },
  { name: "2025 Range Rover Sport", msrp: "$86,600", note: "Current model year clearance pricing available", img: "https://images.unsplash.com/photo-1555404610-4f6162df064d?w=800&h=500&fit=crop&crop=center&q=80" },
];
      ...
      <section className="pb-16 md:pb-24 px-4 md:px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-8">
          {vehicles.map((v) => (
            ...
            >
              <div className="relative h-48 md:h-56 overflow-hidden bg-navy-800">
                <img
                  src={v.img}
                  alt={v.name}
                  loading="lazy"
                ...
                <span className="absolute top-3 right-3 bg-amber/20 backdrop-blur-sm text-amber text-[10px] font-bold px-3 py-1 rounded-full border border-amber/30">
                  Exotic Tier
                </span>
              </div>
              ...
              <div className="p-5 md:p-6">
                <p className="text-sm text-white/40 mb-1">
                  From <span className="font-bold text-white text-xl">{v.msrp}</span> MSRP
                </p>
                {v.note && <p className="text-[12px] text-white/40 leading-relaxed mb-3">{v.note}</p>}
                <p className="text-xs text-amber font-semibold mb-4">&#10022; $1,999 Concierge Service</p>
                <Link
                  href="/car-finder"
