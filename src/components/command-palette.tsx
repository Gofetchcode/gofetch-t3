...
const commands = [
  ...
  { label: "Go to Communications", action: "/dealer/communications", icon: "💬" },
  { label: "Go to Calendar", action: "/dealer/calendar", icon: "📅" },
  { label: "Go to Tasks", action: "/dealer/tasks", icon: "✅" },
  ...
  { label: "Go to Fleet Dashboard", action: "/fleet", icon: "🚛" },
  { label: "Go to Fleet Orders", action: "/fleet/orders", icon: "📦" },
  { label: "Go to Fleet Analytics", action: "/fleet/analytics", icon: "📊" },
  { label: "Go to Car Finder", action: "/car-finder", icon: "🔍" },
  { label: "Go to Home", action: "/", icon: "🏡" },
  { label: "Go to About", action: "/about", icon: "ℹ️" },
  { label: "Go to How It Works", action: "/how-it-works", icon: "🔧" },
  { label: "Go to New Cars", action: "/new-cars", icon: "🚗" },
  { label: "Go to Exotic", action: "/exotic", icon: "🏎️" },
